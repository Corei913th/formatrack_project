...
export default function NotFound({ title, subtitle, shouldRedirect, redirection }: NotFoundProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-linear-to-b from-background to-muted/30 px-4 text-center">
      <div className="relative max-w-md mx-auto">
        ...
        <div className="relative z-10 space-y-8 backdrop-blur-sm bg-background/50 p-8 rounded-xl border shadow-lg">
          {/* Texte 404 avec gradient animé */}
          <div className="relative">
            <h1 className="text-[120px] font-extrabold tracking-tighter leading-none text-transparent bg-clip-text bg-linear-to-r from-primary to-primary/50 animate-gradient">
              404
            </h1>
