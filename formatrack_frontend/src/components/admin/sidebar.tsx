                                  ...
                                  subItem.url && (
                                    <SidebarMenuSubItem key={subItem.title}>
                                      <SidebarMenuSubButton
                                        ...
                                        className="font-medium gap-3 h-9 rounded-md hover:bg-sidebar-accent/20 [&>svg]:size-auto data-[active=true]:bg-transparent data-[active=true]:text-sidebar-accent/70 data-[active=true]:font-semibold"
                                        asChild
                                      >
                                        <Link to={subItem.url}>
