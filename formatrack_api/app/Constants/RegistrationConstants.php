...
class RegistrationConstants
{
    ...
    // Étapes du workflow
    public const STEP_ELIGIBILITY = RegistrationStep::ELIGIBILITY->value;

    public const STEP_PAYMENT_UPLOAD = RegistrationStep::PAYMENT_UPLOAD->value;

    public const STEP_MANUAL_ENTRY = RegistrationStep::MANUAL_ENTRY->value;

    public const STEP_ACCOUNT_CREATION = RegistrationStep::ACCOUNT_CREATION->value;
}
